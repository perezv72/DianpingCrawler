...
# The file containing the links should be in the working directory or make sure that the command has teh correct path.
with open("urls.txt") as f:
    urls = f.readlines()

# Checks if director title html exists, if not, it creates directory.
newpath = r'html'
...
conti = input("Press 1 if page is new format, 2 if page is old style, 0 for to quit ")
